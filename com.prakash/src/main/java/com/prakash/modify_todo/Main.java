package com.prakash.modify_todo;
...
*/
        ...
        // get todos of a certian priority
        ...
        // finally change all todos
        for (int i =1; i <=5 ;i++) {
            updateTodoMethod(i, todoAPI);
        }
    }
    public static void updateTodoMethod(int n, TodoAPIWrapper todoAPI) {
        Todo updateTodo = todoAPI.getTodo(n);

        System.out.println(updateTodo);

        System.out.println("Updating the todo " + n);

        updateTodo.setBody("Body build update " + n);
        updateTodo.setTitle("Exercise body update " + n);
        Random rand = new Random();
        int value = rand.nextInt(6);
        updateTodo.setPriority(value);
        // System.out.println(updateTodo);
        updateTodo = todoAPI.updateTodo(updateTodo);
        System.out.println("Updated todo is");
        System.out.println(updateTodo);
